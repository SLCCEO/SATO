...
const Admin = () => {
    ...
    useEffect(() => {
        ...
        const channel = supabase
            ...
            .on('postgres_changes', { event: '*', schema: 'public', table: 'sato_operations' }, () => refresh())
            .on('postgres_changes', { event: '*', schema: 'public', table: 'sato_judiciary' }, () => refresh())
            .on('postgres_changes', { event: '*', schema: 'public', table: 'sato_archives' }, () => refresh())
            .on('postgres_changes', { event: '*', schema: 'public', table: 'sato_profiles' }, () => refresh())
            .subscribe();
